...
import { fetchItems, filterAssociationItems } from '../actions/AssociationAction'
import {
  Table,
  TableBody,
  TableHeader,
...
class AssociationContainer extends React.Component{
  constructor(props){
    super(props)
  }
  ...
  handleFilter(e,val,d){
    ...
    filterAssociationItems(this.props.dispatch, val);
  }
...
function mapStateToProps(state, ownProps){
  return {
    items: state.AssociationReducer.filteredItems,
